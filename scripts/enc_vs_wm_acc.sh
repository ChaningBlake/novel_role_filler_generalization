...
do
    ...
    do
        ...
        echo "./e2e_enc_dec_query.py data/len5_10000-train.txt data/$i-10-train.txt data/$i-10-test.txt 1 >> .${i}_${j}_output.txt"
    done
done

 #cat .${i}_*_output.txt > \*_e2e_enc_given_roles_${i}.txt
 #rm .${i}_*_output.txt